...
`verify_spec.exs` is standalone — no project, no dependencies. It
validates the notebook's mathematical claims against the closed-form
solution; it does not test `lib/`.
